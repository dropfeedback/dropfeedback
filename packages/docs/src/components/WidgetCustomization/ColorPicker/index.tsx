...
import { defaultPresetColors } from "../constants/presets";
  ...
  return (
    <div className={styles.container}>
          ...
          >
            {value === color && (
              <svg
                ...
                className={invertCheckmark ? styles.invertedCheckmark : ""}
              >
                <path
      ...
      <div
        ...
        className={[styles.colorInput, styles.colorButton].join(" ")}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
